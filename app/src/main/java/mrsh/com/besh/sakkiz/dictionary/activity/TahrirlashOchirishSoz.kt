...
import mrsh.com.besh.sakkiz.dictionary.adapter.CustomAdapter
import mrsh.com.besh.sakkiz.dictionary.classs.ImageCallBack
import mrsh.com.besh.sakkiz.dictionary.classs.MyLifecycleObserver
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saqlashSozQoshish_tahrirlash.setOnClickListener {
            ...
            if (text1.isEmpty() || text2.isEmpty() || text!!.isEmpty() || joyi.isEmpty()) {
                Toast.makeText(this, "Malumot To'liq Emas", Toast.LENGTH_SHORT).show()
            }
            if (text1.isNotEmpty() || text2.isNotEmpty() || text!!.isNotEmpty() || joyi.isNotEmpty()) {

                Toast.makeText(this, "Malumot O'zgartirildi", Toast.LENGTH_SHORT).show()
